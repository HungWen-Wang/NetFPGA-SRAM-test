...
HD_PWD='/root/sram_NetFPGA-SUME-live/sram0924/sram0924.runs/mig_7a_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mig_7a_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mig_7a_0.tcl
